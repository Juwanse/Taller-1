...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais al que corresponde un atleta");
	...
	private void ejecutaratletaPorNacion()
	{
		
		String atleta = input("Por favor ingrese el nombre de un atleta: \n");
		
		System.out.println("El pais del atleta " + atleta + " es " + calculadora.atletaPorNacion(atleta));
	}
